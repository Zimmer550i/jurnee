...
class PostModel {
    ...
    factory PostModel.fromJson(Map<String, dynamic> json) => PostModel(
        ...
        lastSeenLocation: json["lastSeenLocation"] == null ? null : Location.fromJson(json["lastSeenLocation"]),
        ...
        status: json["status"],
        boost: json["boost"],
        attenders: List<Author>.from(json["attenders"].map((x) => Author.fromJson(x))),
